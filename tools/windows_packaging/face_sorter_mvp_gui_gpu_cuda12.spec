...
# Tuned Image Sorter v69.6 / Этап 055 — NVIDIA GPU CUDA 12 one-folder PyInstaller build.
...
APP_NAME = os.environ.get("FACE_SORTER_PYINSTALLER_APP_NAME", "TunedImageSorter_GPU_FULL")
...
hiddenimports, _datas, _binaries = build_profile_inputs(ROOT, PACKAGE_DIR, gpu=True)
